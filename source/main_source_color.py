...
data_zip_name = "Data2"  # String: Name of the .zip of the data uploaded
machine_data_path = "Data_original"  # String: Path in machine for the data to be stored
machine_rs_data_path = "Data_resized"  # String: Path in machine for the resized data to be stored
images_folder = "Images"  # String: Folder inside the Data where the database of images is
scale_percent = 10  # Percentage of resizing
...
def load_train_paths(machine_rs_data_path):
    # LOAD IMAGES PATHS
    img_paths = list()
    for image in os.listdir(os.path.join(machine_rs_data_path, images_folder)):
        img_paths.append(os.path.join(machine_rs_data_path, images_folder, image))
...
def main():
    ...
    #
    # resize_downloaded_images(data_zip_name, machine_data_path, machine_rs_data_path, scale_percent)
    #
    # # Remove data
    # shutil.rmtree(machine_data_path)
